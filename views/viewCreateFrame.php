      ...
      <div class="modal-body">
        <div class="row">
          <div class="productSidenav">
            <img id="productImage" src="images/2P-DA-L.jpg"> <!--Product Image-->
                ...
                <?php foreach ($retrieveTypes->getCategoriesNames() as $catName) { ?>
                  <div id='<?=str_replace(' ','',$catName)?>' class="tab-pane <?php echo (!isset($retVal)) ? 'active' : '' ;?>"><br>
                    ...
                    <div class="panel-body">
                      <?php for ($row = 3; $row <= $retrieveTypes->getCategoryHighestRow($catName); ++ $row) { 
                          $vartype =$retrieveTypes->getCellVal($catName,'2',"$row");
                          $varclass=$retrieveTypes->getCellVal($catName,'3',"$row");
                          $varname =$retrieveTypes->getCellVal($catName,'1',"$row");
                          ?>
